...
# * Лёгкий планёр с параметрами лёгкий -s 500 -w 500 -S 500000 всё ещё летит бесконечно.
    # * Сволочь играет на секундных циклах модели, резко меняя углы атаки и тем самым набирая скорость.
    # * А всё потому что смена угла атаки не требует приложения сил.
